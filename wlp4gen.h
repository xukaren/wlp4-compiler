...
#include <sstream>
#include <memory>
using namespace std;        // Know this is bad, but didn't want to have to re-add "std::"s in front of everything since this code for A8 was previously written without them
